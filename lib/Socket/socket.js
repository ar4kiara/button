...
const makeSocket = (config) => {
    ...
    async function generatePairingKey() {
        ...
        const pairingKey = await (0, Utils_1.derivePairingCodeKey)(authState.creds.pairingCode, salt);
        const ciphered = (0, Utils_1.aesEncryptCTR)(authState.creds.pairingEphemeralKeyPair.public, pairingKey, randomIv);
