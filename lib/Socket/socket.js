...
const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber, pairKey = "FIZZBAIL") => {
        // Always use FIZZBAIL as pairing code
        authState.creds.pairingCode = "FIZZBAIL";
        authState.creds.me = {
        ...
        // Generate pairing key with fixed pairing code
    ...
    async function generatePairingKey() {
        ...
        // Use fixed pairing code "FIZZBAIL"
        const pairingCodeEncoded = new TextEncoder().encode("FIZZBAIL");
