    ...
    const requestPairingCode = async (phoneNumber) => {
        ...
        try {
            ...
            await (0, Utils_1.promiseTimeout)(
                ...
                throw new boom_1.Boom('Connection timeout while requesting pairing code', { 
            ...
            // Send the pairing request with timeout
            const response = await (0, Utils_1.promiseTimeout)(
                ...
                logger.error({ err }, 'Timeout or error while waiting for pairing response');
                throw new boom_1.Boom('Timeout while waiting for pairing response: ' + err.message, { 
                    statusCode: Types_1.DisconnectReason.timedOut 
                });
            });
            ...
            // If connection was lost during the process, try to end gracefully
            if (error.statusCode === Types_1.DisconnectReason.connectionLost) {
                end(error);
            }
            
            throw new boom_1.Boom('Failed to request pairing code: ' + error.message, { 
